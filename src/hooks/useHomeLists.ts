...
const useHomeLists = (
    ...
    const [isLoadingFavouritesWeather, setIsLoadingFavouritesWeather] = useState(
        myFavourites.length > 0 ? true : false
    );
    ...
    const [isLoadingMPCWeather, setIsLoadingMPCWeather] = useState(mostPopulousCities.length > 0 ? true : false);
